...
var _fetchCountiresJs = require("./fetchCountires.js");
...
const inputHandler = (e)=>{
    ...
    (0, _fetchCountiresJs.fetchCountries)(textInput).then((data)=>{
        console.log(data);
        if (data.length > 10) {
        ...
        clearMarkup(refs.countryList);
        clearMarkup(refs.countryInfo);
        (0, _notiflixNotifyAio.Notify).failure("Oops..., there id no country with that name");
    });
};
...
const createListMarkup = (data)=>{
    return data.map(({ name , flags  })=>`<li><img src="${flags.png}" alt="${name.official}" width="60" height="40">"${name.official}"</li>`).join("");
};
const createInfoMarkup = (data)=>{
    return data.map(({ name , capital , population , flags , languages  })=>`<div>
...
refs.searchEl.addEventListener("input", (0, _lodashDebounceDefault.default)(inputHandler, DEBOUNCE_DELAY));

},{"lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-notify-aio":"eXQLZ","./fetchCountires.js":"bCX3g"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"bCX3g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
